...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thị Lành - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 0339288915</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thị Lành - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 0339288915</div>", unsafe_allow_html=True)
